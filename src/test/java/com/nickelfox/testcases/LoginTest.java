...
public class LoginTest {
	...
	//	options.addArguments("--no-sandbox");// Bypass OS security model
		...
		options.addArguments("user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36 Firefox/134.0.2");
